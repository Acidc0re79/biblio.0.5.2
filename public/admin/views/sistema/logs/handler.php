<?php
// Archivo REFACTORIZADO: /public/admin/views/sistema/logs/handler.php

$page_title = "Visor de Logs de Handlers";

// --- LÓGICA DE LA PÁGINA ---

// Apuntamos al archivo de log específico de los handlers
$log_file_path = ROOT_PATH . '/logs/handler.log';
$log_entries = [];
...
<div class="admin-content">
    <div class="content-header">
        ...
        <p>Depura las peticiones enviadas a `form-handler.php` y `ajax-handler.php`.</p>
    </div>
        ...
        <table class="log-table">
            ...
            <tbody>
                <?php if (empty($log_entries)): ?>
                    <tr>
                        <td colspan="4">El archivo de log de handlers está vacío o no existe.</td>
                    </tr>
                <?php else: ?>
