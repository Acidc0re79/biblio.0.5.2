<?php
// Archivo REFACTORIZADO: /public/admin/views/sistema/logs/frontend.php

$page_title = "Visor de Logs del Frontend";

// --- LÓGICA DE LA PÁGINA ---

// Apuntamos al archivo de log específico del frontend
$log_file_path = ROOT_PATH . '/logs/frontend.log';
$log_entries = [];
...
<div class="admin-content">
    <div class="content-header">
        <h2><i class="fab fa-js-square"></i> <?= htmlspecialchars($page_title) ?></h2>
        <p>Registra los errores de JavaScript y otros eventos que ocurren en el navegador del cliente.</p>
    </div>
        ...
        <table class="log-table">
            ...
            <tbody>
                <?php if (empty($log_entries)): ?>
                    <tr>
                        <td colspan="4">El archivo de log del frontend está vacío o no existe.</td>
                    </tr>
                <?php else: ?>
